...
const Contact = () => {
  return (
    <div className="bg-[#849591]">
      <div className="flex items-center justify-center md:gap-8 gap-0 md:[&_div]:mt-20 [&_div]:mt-14 flex-col md:flex-row">
        <div className="text-center md:max-w-[200px] text-white [&_p]:font-light [&_p]:text-[11px]">
          ...
          <p>FREE SHIPPING</p>
          <p className=" mt-1">For any order over 350k of purchase.</p>
        </div>
      ...
      <div className="grid md:grid-cols-7 gap-8 md:mt-16  place-content-center">
        ...
        <div className="[&_p]:text-[11px] [&_p]:text-[#fefbf5] [&_p]:font-light">
          <h2 className="text-[#fefbf5] md:text-base text-sm mb-1 md:mt-0 mt-20">
            DISCOVER US
          </h2>
      ...
      <div className="flex items-center justify-center md:p-2 md:mt-8 p-1 mt-4">
